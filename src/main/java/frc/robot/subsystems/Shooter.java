...
public class Shooter extends SubsystemBase {
	...
	public Shooter(CommandSwerveDrivetrain drivetrain) {
 	   ...
 	   leftConfig.signals
        .primaryEncoderVelocityPeriodMs(ShooterConstants. kPrimaryEncoderVelocityPeriod)
        .primaryEncoderPositionPeriodMs(ShooterConstants.kPrimaryEncoderPositionPeriod)
        .absoluteEncoderPositionPeriodMs(ShooterConstants.kAbsoluteEncoderPositionPeriod);
